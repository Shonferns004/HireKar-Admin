      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 font-medium mt-1">Sign in to access the admin panel</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-xs font-black text-slate-700 uppercase tracking-wider mb-2">Username</label>
              <input
                type="text"
                value={username}
            ...
            <button
              ...
              className="w-full text-white font-black py-3 rounded-xl shadow-lg shadow-primary/20 bg-black transition-all transform active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
          ...
          <div className="mt-6 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
            Username: <span className="font-bold text-slate-900">{ADMIN_CREDENTIALS.username}</span> | Password: <span className="font-bold text-slate-900">{ADMIN_CREDENTIALS.password}</span>
          </div>
